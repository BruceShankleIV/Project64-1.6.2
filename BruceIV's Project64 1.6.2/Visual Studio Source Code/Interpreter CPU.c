...
void BuildInterpreter (void ) {
	...
	R4300i_Special[48] = DUMMY; // TGE
	R4300i_Special[49] = DUMMY; // TGEU
	R4300i_Special[50] = DUMMY; // TLT
	R4300i_Special[51] = DUMMY; // TLTU
	R4300i_Special[52] = DUMMY; // TEQ
	R4300i_Special[54] = DUMMY; // TNE
	...
	R4300i_Regimm[8] = DUMMY; // TGEI
	R4300i_Regimm[9] = DUMMY; // TGEIU
	R4300i_Regimm[10] = DUMMY; // TLTI
	R4300i_Regimm[11] = DUMMY; // TLTIU
	R4300i_Regimm[12] = DUMMY; // TEQI
	R4300i_Regimm[14] = DUMMY; // TNEI
	R4300i_Regimm[16] = r4300i_REGIMM_BLTZAL;
	R4300i_Regimm[17] = r4300i_REGIMM_BGEZAL;
	R4300i_Regimm[18] = DUMMY; // BLTZALL
	R4300i_Regimm[19] = DUMMY; // BGEZALL
