...
*********************************************************************************/
	...
	{ MENUDES_CUSTOM,	  "Captures gameplay with whatever parameters your heart desires"},
	{ LOW_PRESET,		  "Low Quality YUV (recommended)"},
	{ MEDIUM_PRESET,	  "Medium Quality RGB (low playback support)"},
	{ CUSTOM_QUALITY,	  "Custom Quality (not recommended)"},
	{ GAME_CAPTURE,		  "ffmpeg Game Capture (WIP, no audio yet)"},
	{ FFMPEG_NOFIND,	  "Unable to find ffmpeg"},
	{ FFMPEG_NOSTART,	  "Unable start ffmpeg"},
};
class CLanguage  {
