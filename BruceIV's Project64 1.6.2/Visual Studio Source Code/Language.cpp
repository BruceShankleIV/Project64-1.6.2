...
//Plugin Dialog
	...
	{ DIR_INSTANT_SAVE, "Save States"},
        { DIR_SCREEN_SHOT,  "Screenshots and Videos"},
	...
	{ DIR_SELECT_INSTANT,"Select Save States Directory"},
        { DIR_SELECT_SCREEN,"Select Screenshots and Videos Directory"},
	...
	{ ROM_JAI,   "Jabo AI"},
	{ ROM_USE_TLB,        "Translation Lookaside Buffer"},
	...
	{ CORE_RECOMPILER,    "Recompile VR4300i CPU"},
//RDRAM Size
...
*********************************************************************************/
	...
	{ MENUDES_CUSTOM,	  "Captures gameplay in a lossless RGBA PNG screenshot"},
