...
October 18th EDIT: WIP 10 has turned into Beta 10.0, this will be released as an open beta and anybody who plays through a game and confirms whether there is an issue or not will be cited as a beta tester. We're still working on doing minimal testing before releasing this. Yes I know I have delayed it forever, but it's going to be worth the wait. In fact I got GB tower working at full speed yesterday, I think an emulator inside an emulator is pretty dang cool! lol. That won't work with current public build, but
it does work in Beta 10.0. I'm not really sure when I'll release it now, hopefully halloween or something. Anyways, just updating this text file again so onlookers know the project isn't dead. I just don't commit changes now until I am completely satisfied.
